...
Write-ahead journal for GPU state mutations with ternary integrity. {+1=committed, 0=pending, -1=corrupted}. Replay, checkpoint, compaction.
...
```bash
git clone https://github.com/SuperInstance/oxide-journal.git
cd oxide-journal
cargo test    # 8 tests
```
